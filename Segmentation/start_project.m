%  start_project: Create or update a 3-View (Front, Top, Side) of the 
%	brain data that is specified by nii structure
%
%  Usage:  	status = start_project([h], nii, [option])	or
%		status = start_project(h, [option])
%
...
%
function status = start_project(varargin)

   if nargin < 1
      error('Please check inputs using ''help start_project''');
   end;
...
fig = init(nii, fig, setarea, setunit, setviewpoint, setscanid, setbuttondown, ...
   ...
   case {'updatenii'}
      ...
      start_project(fig, opt);

      opt.command = 'init';
      start_project(fig, nii, opt);
   ...
   case {'clearnii'}
      ...
      mymotion = '; start_project(''move_cursor'');';
...
%      highcolor = [zeros(1,3);gray(55)];
   ...
   if xdim > 1,
      ...
      handles.sagittal_slider = uicontrol('Parent',fig, ...
                ...
                'Callback','start_project(''sagittal_slider'');');
   ...
   if ydim > 1,
      ...
      handles.coronal_slider = uicontrol('Parent',fig, ...
                ...
                'Value',slider_val,...
                'Callback','start_project(''coronal_slider'');');
...
%   h = front_pos(4);
   ...
   if zdim > 1,
      ...
      handles.axial_slider = uicontrol('Parent',fig, ...
                ...
                'Callback','start_project(''axial_slider'');');
...
%   info_pos = info_pos(:);
   ...
   handles.impos = uicontrol('Parent',fig,'Style','edit', ...
        ...
        'BusyAction','queue',...
        'Callback','start_project(''impos_edit'');', ...
...
if 0
   ...
   handles.coord = uicontrol('Parent',fig,'Style','popupmenu', ...
      ...
      'visible','off', ...
      'Callback','start_project(''coordinates'');');
...
%      'String',{'Voxel','MNI (mm)','Talairach (mm)'},...
   ...
   handles.xhair_color = uicontrol('Parent',fig,'Style','push', ...
      ...
      'String','Color',...
      'visible','off', ...
      'Callback','start_project(''xhair_color'');');
   ...
   handles.xhair = uicontrol('Parent',fig,'Style','popupmenu', ...
      ...
      'String',{'On','Off'},...
      'visible','off', ...
      'Callback','start_project(''crosshair'');');
...
%      set(handles.hist_frame, 'visible', 'on');
   ...
   handles.hist_eq = uicontrol('Parent',fig,'Style','toggle', ...
      ...
      'String','Hist EQ',...
      'visible','off', ...
      'Callback','start_project(''hist_eq'');');
...
%      set(handles.hist_eq, 'visible', 'on');
   ...
   handles.hist_plot = uicontrol('Parent',fig,'Style','push', ...
      ...
      'String','Hist Plot',...
      'visible','off', ...
      'Callback','start_project(''hist_plot'');');
...
%      'String',{'Voxel','MNI (mm)','Talairach (mm)'},...
   ...
   handles.neg_color = uicontrol('Parent',fig,'Style','toggle', ...
      ...
      'String','Negative',...
      'visible','off', ...
      'Callback','start_project(''neg_color'');');
...
%      set(handles.Thist, 'visible', 'on');
   ...
   handles.contrast = uicontrol('Parent',fig, ...
      ...
      'Value',1, ...
      'visible','off', ...
      'Callback','start_project(''contrast'');');
   ...
   if nii_view.numscan > 1
      set(handles.contrast, 'min', 1, 'max', nii_view.numscan, ...
         ...
         'Callback', 'start_project(''slider_change_scan'');');
   ...
   handles.brightness = uicontrol('Parent',fig, ...
      ...
      'Value',0, ...
      'visible','off', ...
      'Callback','start_project(''brightness'');');
   ...
   handles.contrast_def = uicontrol('Parent',fig,'Style','push', ...
      ...
      'String','Reset',...
      'visible','off', ...
      'Callback','start_project(''contrast_def'');');
   ...
   if nii_view.numscan > 1
      set(handles.contrast_def, 'style', 'edit', 'background', 'w', ...
         ...
         'string', '1', 'Callback', 'start_project(''edit_change_scan'');');
   elseif colorindex < 2 | colorindex > 3
   ...
   handles.brightness_def = uicontrol('Parent',fig,'Style','push', ...
      ...
      'String','Reset',...
      'visible','off', ...
      'Callback','start_project(''brightness_def'');');
   ...
   h1 = plot_view(fig, xdim, ydim, top_ax, img_slice, clim, cbarminmax, ...
	handles, useimagesc, colorindex, color_map, ...
	colorlevel, highcolor, useinterp, nii_view.numscan);
   set(h1,'buttondown','start_project(''axial_image'');');
   ...
   h1 = plot_view(fig, xdim, zdim, front_ax, img_slice, clim, cbarminmax, ...
	handles, useimagesc, colorindex, color_map, ...
	colorlevel, highcolor, useinterp, nii_view.numscan);
   set(h1,'buttondown','start_project(''coronal_image'');');
   ...
   h1 = plot_view(fig, ydim, zdim, side_ax, img_slice, clim, cbarminmax, ...
	handles, useimagesc, colorindex, color_map, ...
	colorlevel, highcolor, useinterp, nii_view.numscan);
   set(h1,'buttondown','start_project(''sagittal_image'');');
...
if 0
   ...
   windowbuttonmotion = [windowbuttonmotion '; start_project(''move_cursor'');'];
...
function update_useinterp(fig, useinterp)
   ...
   if ~isempty(nii_view.handles.axial_image)
      ...
      set(nii_view.handles.axial_image,'buttondown','start_project(''axial_image'');');
   end
   ...
   if ~isempty(nii_view.handles.coronal_image)
      ...
      set(nii_view.handles.coronal_image,'buttondown','start_project(''coronal_image'');');
   end
   ...
   if ~isempty(nii_view.handles.sagittal_image)
      ...
      set(nii_view.handles.sagittal_image,'buttondown','start_project(''sagittal_image'');');
   end
...
function update_scanid(fig, setscanid)
   ...
   start_project(fig, nii_view.nii.img, opt);
